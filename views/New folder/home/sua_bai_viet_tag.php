<?
$id_skill = getValue('id', 'int', "GET", "");
$post_qr = new db_query("SELECT id_skill,skill_name,content,title_suggest,content_suggest FROM skills WHERE id_skill = '$id_skill'");
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Sửa bài viết kĩ năng</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Sửa bài viết kĩ năng</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="" class="insert_form" data-type="tag" data-id="<?= $post['id_skill'] ?>" method="POST">
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <div class="t_input mb-2">
                                            <label for="">Tên kĩ năng</label>
                                            <input type="text" readonly class="ten_tinh_thamh form-control" value="<?= $post['skill_name'] ?>">
