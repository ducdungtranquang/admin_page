<?
  $user_list_qr= new db_query("SELECT id_user,email,phone,name,avatar,type,created_at,user_active FROM users WHERE user_type = 1 ");
?>
              ...
              <div class="card-body">
                <table id="uv_list" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><a href="sua_nha_tuyen_dung?id=<?=$uv['id_user']?>">Sửa</a></td>
