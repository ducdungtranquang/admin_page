<?
$id_cit = getValue('id', 'int', "GET", "");
$post_qr = new db_query("SELECT cit_id,cit_name,content,title_suggest,content_suggest FROM city WHERE cit_id = '$id_cit'");
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Sửa bài viết tỉnh thành</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Sửa bài viết tỉnh thành</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="" class="insert_form" data-type="city" data-id="<?= $post['cit_id'] ?>" method="POST">
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <div class="t_input mb-2">
                                            <label for="">Tên tỉnh thành</label>
                                            <input type="text" readonly class="ten_tinh_thamh form-control" value="<?= $post['cit_name'] ?>">
