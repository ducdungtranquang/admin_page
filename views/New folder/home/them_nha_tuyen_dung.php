        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Thêm nhà tuyển dụng</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card">
              <!-- /.card-header -->
              <div class="card-body">
                <form id="them_ung_vien" method="POST" action="/admin/process_code/them_nha_tuyen_dung.php" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="uv_name" placeholder="Nhập tên nhà tuyển dụng" value="">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Email</label>
                        <span class="badge badge-danger">*</span>
                        <input type="text" class="form-control" name="uv_email" id="uv_mail" placeholder="Nhập email nhà tuyển dụng" value="" >
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
