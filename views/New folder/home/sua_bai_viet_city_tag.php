...
$post_qr = new db_query("SELECT id,skill_id,cit_id,content,title_suggest,content_suggest FROM post_city_category WHERE id = '$id' AND category_id IS NULL");
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Sửa bài viết tỉnh thành kĩ năng</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Sửa bài tỉnh thành viết kĩ năng</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="" class="insert_form" data-type="citytag" data-id="<?=$post['id'] ?>" method="POST">
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <div class="t_input mb-2">
                                            <label for="">Tên kĩ năng</label>
                                            <input type="text" readonly class="ten_linh_vuc form-control" value="<?=$skills_arr[$post['skill_id']]['skill_name'] ?>">
