<?
$id_cate = getValue('id', 'int', "GET", "");
$post_qr = new db_query("SELECT id_category,category_name,content,title_suggest1,content_suggest FROM category WHERE id_category = '$id_cate'");
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Sửa bài viết lĩnh vực</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Sửa bài viết lĩnh vực</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="" class="insert_form" data-type="cate" data-id="<?= $post['id_category'] ?>" method="POST">
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <div class="t_input mb-2">
                                            <label for="">Tên lĩnh vực</label>
                                            <input type="text" readonly class="ten_tinh_thamh form-control" value="<?= $post['category_name'] ?>">
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="t_input mb-2">
                                            ...
                                            <input type="text" placeholder="Tiêu đề gợi ý" class="tieude_goiy form-control" id="tieude_goiy" value="<?= $post['title_suggest1'] ?>">
