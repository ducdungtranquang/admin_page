...
CKEDITOR.plugins.add( 'combobutton',
{
	...
	onLoad : function()
	{
		...
		//					' onfocus="return CKEDITOR.ui.button._.focus(', index, ', event);"' +
					...
					if ( this.icon )
					{
						var offset = ( this.iconOffset || 0 ) * 0 // * -16;
						output.push( ' class="cke_button_icon" style="background-image:url(', CKEDITOR.getUrl( this.icon ), ');background-position:0 ' + offset + 'px;"' );
					}
					//<span style="background-image:url(http://localhost:7001/admin/resource/ckeditor/plugins/table/icons/table.png?t=E7KD);background-position:0 0px;background-size:16px;">&nbsp;</span>

					output.push(
								'>&nbsp;</span>' +
								'<span id="', id, '_label" class="cke_button_label" aria-hidden="false">', this.label, '</span>' );
