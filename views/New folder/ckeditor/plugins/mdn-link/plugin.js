...
/*
	...
	This plugin was copied from CKEditor's own "link" plugin and then modified
	
	Goals of customization to:
	
		- Add the "Search" tab for autosuggesting of article titles
*/
