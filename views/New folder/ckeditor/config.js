...
(function () {
	...
	CKEDITOR.editorConfig = function (config) {
		...
		***/
		...
		// File browser
		config.filebrowserBrowseUrl = "https://freelancer.timviec365.vn/admin/ckeditor/ckfinder/ckfinder.php",
			config.filebrowserUploadUrl = "https://freelancer.timviec365.vn/admin/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files",
			config.filebrowserImageUploadUrl = "https://freelancer.timviec365.vn/admin/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images",
			config.filebrowserFlashUploadUrl = "https://freelancer.timviec365.vn/admin/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash",
