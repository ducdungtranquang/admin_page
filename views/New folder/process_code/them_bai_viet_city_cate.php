...
if ($check_qr->total == 0) {
    $selected_pr = new db_query("INSERT INTO post_city_category (`cit_id`,`category_id`,`content`,`title_suggest`,`content_suggest`,`created_at`) VALUE ('$cit_id','$cate_id','$noidung','$tieude_goiy','$noidung_goiy','$created')");
    echo json_encode([
        'result' => true,
        'msg'    => 'Thêm thành công',
    ]);
