...
VALUES ('$ntd_id','$job_name','$job_name_alias','$uv_linh_vuc', '$uv_skill', '$uv_jobtype', '$uv_city','$uv_exp','$uv_des','1','$uv_luong','$uv_luong1','$uv_luong2','$ht_luong_time','$price_start_date','$price_end_date','$work_start_date','$work_term','1','$created_at')");
